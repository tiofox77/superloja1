                ...
                <div class="border-2 rounded-lg p-5 {{ $facebook_messenger_enabled ? 'border-purple-300 bg-purple-50' : 'border-gray-200 bg-gray-50' }}">
                    ...
                    @if($facebook_messenger_enabled)
                        <div class="space-y-3">
                            ...
                            <button type="button" wire:click="testMessenger"
                                    wire:loading.attr="disabled"
                                    wire:target="testMessenger"
                                    class="w-full px-4 py-2 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 font-semibold text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                <span wire:loading.remove wire:target="testMessenger">🧪 Testar Messenger</span>
                                <span wire:loading wire:target="testMessenger" class="flex items-center justify-center gap-2">
                                    <svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                ...
                <div class="border-2 rounded-lg p-5 {{ $instagram_enabled ? 'border-pink-300 bg-pink-50' : 'border-gray-200 bg-gray-50' }}">
                    ...
                    @if($instagram_enabled)
                        <div class="space-y-3">
                            ...
                            <button type="button" wire:click="testInstagram"
                                    wire:loading.attr="disabled"
                                    wire:target="testInstagram"
                                    class="w-full px-4 py-2 bg-pink-100 text-pink-700 rounded-lg hover:bg-pink-200 font-semibold text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                <span wire:loading.remove wire:target="testInstagram">🧪 Testar Instagram</span>
                                <span wire:loading wire:target="testInstagram" class="flex items-center justify-center gap-2">
                                    <svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
