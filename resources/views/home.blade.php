...
@section('title', 'SuperLoja - A melhor loja de eletrônicos de Angola')
...
/* Custom Scrollbar for Hero Products */
.hero-products::-webkit-scrollbar {
    width: 6px;
}

.hero-products::-webkit-scrollbar-track {
    background: rgba(255, 255, 255, 0.1);
    border-radius: 3px;
}

.hero-products::-webkit-scrollbar-thumb {
    background: rgba(255, 255, 255, 0.3);
    border-radius: 3px;
}

.hero-products::-webkit-scrollbar-thumb:hover {
...
.floating-shape-1, .floating-shape-2, .floating-shape-3, .floating-shape-4,
.animate-fade-in-up, .animate-fade-in-right, .animate-gradient-x {
