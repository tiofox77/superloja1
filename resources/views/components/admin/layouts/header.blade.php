    ...
    <div class="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <nav class="hidden sm:flex items-center gap-2 text-sm">
                <a href="{{ route('admin.dashboard') }}" wire:navigate class="text-gray-400 hover:text-primary-500 transition-colors">
                ...
                @if(isset($breadcrumb))
                    @foreach($breadcrumb as $item)
                        ...
                        @else
                            <a href="{{ $item['url'] }}" wire:navigate class="text-gray-500 hover:text-primary-500 transition-colors">
                                {{ $item['label'] }}
                            </a>
                        @endif
                    @endforeach
