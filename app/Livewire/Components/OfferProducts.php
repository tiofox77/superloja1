...
class OfferProducts extends Component
{
    ...
    private function loadProducts(): void
    {
        ...
        if (!empty($this->priceRange)) {
            switch ($this->priceRange) {
                case 'under-200000':
                    $query->where('sale_price', '<', 200000);
                    break;
                case '200000-500000':
                    $query->whereBetween('sale_price', [200000, 500000]);
                    break;
                case '500000-1000000':
        ...
        $this->products = $query->take(12)->get();
    }
    ...
    {
        return view('livewire.components.offer-products');
    }
}
