                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-white space-y-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style="animation-delay: 0.3s">
                            <a href="<?php echo e(route('products')); ?>" wire:navigate
                            ...
                            <a href="<?php echo e(route('auctions')); ?>" wire:navigate
                        ...
                        <div class="grid grid-cols-3 gap-8 pt-8 animate-fade-in-up" style="animation-delay: 0.6s">
                            <div class="text-center">
                                <div class="text-3xl font-bold text-yellow-300"><?php echo e($stats['products'] ?? 0); ?>+</div>
                                <div class="text-white/80 text-sm">Produtos</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-yellow-300"><?php echo e($stats['categories'] ?? 0); ?>+</div>
                                <div class="text-white/80 text-sm">Categorias</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-yellow-300"><?php echo e($stats['brands'] ?? 0); ?>+</div>
...
[$__name, $__params] = $__split('components.featured-products-mini');

$__html = app('livewire')->mount($__name, $__params, 'lw-360573792-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('components.featured-products', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-360573792-1', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="text-center mt-16">
                ...
                <p class="text-gray-500 mt-4">Mais de <?php echo e($stats['products'] ?? 0); ?> produtos disponíveis</p>
            </div>
        </div>
    </section>
...
[$__name, $__params] = $__split('components.latest-products', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-360573792-2', $__slots ?? [], get_defined_vars());
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="text-white space-y-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="<?php echo e(route('health.wellness')); ?>" wire:navigate
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/pages/home.blade.php ENDPATH**/ ?>