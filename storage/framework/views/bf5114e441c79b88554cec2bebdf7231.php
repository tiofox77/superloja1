<div>
    ...
    <div class="fixed top-4 right-4 z-50 space-y-2" id="toast-container">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div 
                id="toast-<?php echo e($notification['id']); ?>"
                ...
                wire:key="toast-<?php echo e($notification['id']); ?>"
            >
                <div class="p-4">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <!--[if BLOCK]><![endif]--><?php if($notification['type'] === 'success'): ?>
                        ...
                        <div class="ml-4 flex-shrink-0 flex">
                            <button 
                                wire:click="removeNotification('<?php echo e($notification['id']); ?>')"
                ...
                <div class="h-1 bg-gray-200 relative overflow-hidden">
                    <div 
                        ...
                        <?php if($notification['type'] === 'success'): ?> from-green-500 to-green-600
                        <?php elseif($notification['type'] === 'error'): ?> from-red-500 to-red-600
                        <?php elseif($notification['type'] === 'warning'): ?> from-yellow-500 to-yellow-600
                        <?php else: ?> from-blue-500 to-blue-600
                        <?php endif; ?>"
                        style="width: 100%; animation: countdown <?php echo e($notification['duration']); ?>ms linear forwards;"
                    ></div>
                </div>
            </div>
        ...
        Livewire.on('auto-remove-toast', (data) => {
            setTimeout(() => {
                ...
                if (toast) {
                    ...
                    setTimeout(() => {
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').removeNotification(data.id);
                    }, 300);
                }
            }, data.duration);
        });
...
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/components/toast-notifications.blade.php ENDPATH**/ ?>