            ...
            <div class="p-2">
                ...
                <div class="flex items-center mb-2">
                    ...
                    <span class="text-xs text-green-600 font-medium">
                        Adicionado <?php echo e($product->created_at->format('d/m')); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $currentImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button wire:click="setMainImage(<?php echo e($index); ?>)" 
                                                    class="flex-shrink-0 w-16 h-16 bg-gray-100 rounded-lg overflow-hidden border-2 transition-colors
                                                           <?php echo e($index === $mainImageIndex ? 'border-blue-500' : 'border-gray-200 hover:border-gray-300'); ?>">
                            ...
                            <div class="w-full sm:w-1/2">
                                ...
                                <div class="mb-2">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        🆕 NOVO - <?php echo e($selectedProduct->created_at->format('d/m/Y')); ?>
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center">
                                        <div class="flex text-yellow-400">
                                            <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < 5; $i++): ?>
                                                <!--[if BLOCK]><![endif]--><?php if($i < ($selectedProduct->rating_average ?? 0)): ?>
                                        ...
                                        <span class="ml-2 text-sm text-gray-500">(<?php echo e($selectedProduct->rating_count ?? 0); ?>)</span>
                                    </div>
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php if($variant->is_active && $variant->stock_quantity > 0): ?>
                                                            <button type="button" 
                                                                ...
                                                                <!--[if BLOCK]><![endif]--><?php if($variant->price_adjustment != 0): ?>
                                                                    <span class="ml-1 font-medium <?php echo e(isset($selectedVariants[$variantName]) && $selectedVariants[$variantName] == $variant->id ? 'text-blue-100' : 'text-blue-600'); ?>">
                                                                        <?php echo e($variant->price_adjustment > 0 ? '+' : ''); ?><?php echo e(number_format($variant->price_adjustment, 0, ',', '.')); ?> Kz
                                                                    </span>
                                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                                <span class="ml-1 <?php echo e(isset($selectedVariants[$variantName]) && $selectedVariants[$variantName] == $variant->id ? 'text-blue-100' : 'text-gray-500'); ?>">(<?php echo e($variant->stock_quantity); ?>)</span>
                                                            </button>
                                                        <?php else: ?>
...
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/components/latest-products.blade.php ENDPATH**/ ?>