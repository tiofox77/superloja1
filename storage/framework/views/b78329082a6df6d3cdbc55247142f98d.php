<div class="relative">
    ...
    <div x-data="{ open: <?php if ((object) ('showDropdown') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDropdown'->value()); ?>')<?php echo e('showDropdown'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDropdown'); ?>')<?php endif; ?> }">
    <!-- Notification Bell -->
    <button 
    ...
    >
        ...
        <!--[if BLOCK]><![endif]--><?php if($unreadCount > 0): ?>
            <span class="absolute -top-1 -right-1 bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold shadow-md ring-2 ring-white">
                <span class="relative z-10"><?php echo e($unreadCount > 99 ? '99+' : $unreadCount); ?></span>
            </span>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="max-h-96 overflow-y-auto">
            <!--[if BLOCK]><![endif]--><?php if($notifications && $notifications->count() > 0): ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div 
                        class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors duration-150 <?php echo e($notification->isUnread() ? 'bg-blue-50' : ''); ?>"
                        wire:click="markAsRead(<?php echo e($notification->id); ?>)"
                    >
                        <div class="flex items-start space-x-3">
                            <!-- Icon based on notification type -->
                            <div class="flex-shrink-0 mt-1">
                                <!--[if BLOCK]><![endif]--><?php switch($notification->type):
                                    case ('order_status'): ?>
                                    ...
                                    <?php case ('auction_status'): ?>
                                        ...
                                        <?php break; ?>
                                    <?php case ('product_request'): ?>
                                    <?php case ('product_request_status'): ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-2">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($notification->isUnread()): ?>
                                        <div class="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0 mt-1"></div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                                <p class="text-sm text-gray-600 mt-2 leading-relaxed">
                                    <?php echo e(Str::limit($notification->message, 100)); ?>

                                </p>
                                <div class="flex items-center justify-between mt-2">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                        <?php echo e($notification->getTypeLabel()); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($notifications && $notifications->count() > 0): ?>
            <div class="px-4 py-3 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-blue-50 rounded-b-2xl">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-500"><?php echo e($notifications->count()); ?> de <?php echo e($notifications->count()); ?></span>
                </div>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
...
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/notification-dropdown.blade.php ENDPATH**/ ?>