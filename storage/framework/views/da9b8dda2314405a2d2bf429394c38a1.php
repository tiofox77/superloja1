        ...
        <div class="fixed top-20 right-4 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50" 
            ...
            <div class="p-6">
                ...
                <div class="space-y-3 max-h-80 overflow-y-auto">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $wishlistItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-gray-50 rounded-xl p-3" wire:key="wishlist-item-<?php echo e($item['id']); ?>">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-medium text-sm text-gray-900 truncate"><?php echo e($item['name']); ?></h4>
                                    <!--[if BLOCK]><![endif]--><?php if($item['category']): ?>
                                        <p class="text-xs text-gray-500 mb-1"><?php echo e($item['category']); ?></p>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    
                                    <div class="flex items-center justify-between">
                                        <div class="text-sm">
                                            <!--[if BLOCK]><![endif]--><?php if($item['sale_price']): ?>
                                                <span class="font-semibold text-red-600"><?php echo e(number_format($item['sale_price'], 0, ',', '.')); ?> Kz</span>
                                                <span class="text-xs text-gray-500 line-through ml-1"><?php echo e(number_format($item['price'], 0, ',', '.')); ?> Kz</span>
                                            <?php else: ?>
                                                <span class="font-semibold text-gray-900"><?php echo e(number_format($item['price'], 0, ',', '.')); ?> Kz</span>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                        
                                        <div class="flex items-center space-x-1">
                                            <!-- Move to Cart -->
                                            <button wire:click="moveToCart(<?php echo e($item['id']); ?>)" 
                                            ...
                                            <!-- Remove -->
                                            <button wire:click="removeItemById(<?php echo e($item['id']); ?>)" 
                ...
                <!--[if BLOCK]><![endif]--><?php if(count($wishlistItems) > 0): ?>
                    <!-- Action Buttons -->
...
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/components/wishlist-header.blade.php ENDPATH**/ ?>