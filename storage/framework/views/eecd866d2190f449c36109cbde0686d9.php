    ...
    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <a href="/produtos" class="block">
            <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-4 hover:bg-white/30 transition-all duration-300 transform hover:scale-105 cursor-pointer group">
                ...
                <h4 class="text-white font-semibold text-sm mb-1 truncate group-hover:text-yellow-300 transition-colors"><?php echo e($product->name); ?></h4>
                ...
                <div class="mt-2">
                    <!--[if BLOCK]><![endif]--><?php if($product->sale_price && $product->sale_price > 0): ?>
                        ...
                        ?>
                        <span class="bg-red-500 text-white text-xs px-2 py-1 rounded-full group-hover:bg-red-600 transition-colors">-<?php echo e($discount); ?>% OFF</span>
                    ...
                    <?php else: ?>
                        <span class="bg-blue-500 text-white text-xs px-2 py-1 rounded-full group-hover:bg-blue-600 transition-colors"><?php echo e($product->category->name ?? 'Produto'); ?></span>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
            </div>
        </a>
...
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/components/featured-products-mini.blade.php ENDPATH**/ ?>