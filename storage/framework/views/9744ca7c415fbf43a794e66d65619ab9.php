<div>
    ...
    <button wire:click="toggleCart" class="relative p-3 text-gray-600 hover:text-orange-500 hover:bg-gradient-to-br hover:from-orange-50 hover:to-red-50 rounded-2xl transition-all duration-300 group shadow-lg hover:shadow-xl">
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->itemCount > 0): ?>
            <span class="absolute -top-2 -right-2 bg-gradient-to-br from-red-500 via-orange-500 to-yellow-500 text-white text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold shadow-lg animate-bounce border-2 border-white">
                <?php echo e($this->itemCount > 99 ? '99+' : $this->itemCount); ?>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500"><?php echo e($this->itemCount); ?> <?php echo e($this->itemCount === 1 ? 'item' : 'itens'); ?></p>
                    </div>
                ...
                <div class="space-y-4 max-h-80 overflow-y-auto">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-gray-50 rounded-xl p-4" wire:key="cart-item-<?php echo e($item['id']); ?>">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-medium text-sm text-gray-900"><?php echo e($item['name']); ?></h4>
                                    <p class="text-xs text-gray-500 mb-2">SKU: <?php echo e($item['sku'] ?? 'N/A'); ?></p>
                                    
                                    <div class="flex items-center justify-between">
                                        <!-- Quantity Controls -->
                                        <div class="flex items-center bg-white rounded-lg border border-gray-200">
                                            <button wire:click="decreaseQuantity(<?php echo e($item['id']); ?>)" class="p-2 hover:bg-gray-100 rounded-l-lg transition-colors">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"></path>
                                                </svg>
                                            </button>
                                            <span class="px-3 py-2 text-sm font-medium min-w-[40px] text-center"><?php echo e($item['quantity']); ?></span>
                                            <button wire:click="increaseQuantity(<?php echo e($item['id']); ?>)" class="p-2 hover:bg-gray-100 rounded-r-lg transition-colors">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="text-right">
                                            <p class="text-xs text-gray-500"><?php echo e(number_format($item['price'], 0, ',', '.')); ?> Kz cada</p>
                                            <p class="font-semibold text-sm text-orange-600"><?php echo e(number_format($item['price'] * $item['quantity'], 0, ',', '.')); ?> Kz</p>
                                        </div>
                                    </div>
                                </div>
                                
                                <!-- Remove Button -->
                                <button wire:click="removeItem(<?php echo e($item['id']); ?>)" class="text-gray-400 hover:text-red-500 p-1 flex-shrink-0">
                ...
                <!--[if BLOCK]><![endif]--><?php if(count($cartItems) > 0): ?>
                    ...
                    <div class="border-t border-gray-200 mt-4 pt-4 space-y-2">
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="font-medium"><?php echo e(number_format($this->total, 0, ',', '.')); ?> Kz</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                        ...
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="font-medium"><?php echo e(number_format($this->total * 0.1, 0, ',', '.')); ?> Kz</span>
                        </div>
                        <div class="border-t border-gray-200 pt-2">
                            <div class="flex justify-between items-center">
                                <span class="font-semibold text-gray-900">Total:</span>
                                <span class="font-bold text-lg text-orange-600"><?php echo e(number_format($this->total * 1.1, 0, ',', '.')); ?> Kz</span>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\superloja\resources\views/livewire/components/cart-header.blade.php ENDPATH**/ ?>